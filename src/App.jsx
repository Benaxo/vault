  ...
  return (
    <div className="min-h-screen bg-gray-100">
          ...
          <div className="flex items-center space-x-4">
            ...
            {hasAppAccess() && userProfile && (
              <UserDropdown
                ...
                setIsLinkWalletModalOpen={setIsLinkWalletModalOpen}
              />
            )}
      ...
      <main className="container mx-auto px-4 py-8">
        {/* Hero Section - Show when no access */}
        {!hasAppAccess() && (
          <div className="mb-12">
            <Hero />
            <div className="mt-8 text-center">
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg p-8 max-w-3xl mx-auto">
                <h3 className="text-2xl font-bold text-gray-800 mb-4">
                  🚀 Get Started with PiggyBank Vault
                </h3>
                <p className="text-gray-600 mb-6">
                  Start your savings journey! You can begin with either option:
                </p>
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-white p-6 rounded-lg shadow-sm">
                    ...
                    <p className="text-gray-600 text-sm mb-4">
                      Sign up with Google or email to save your goals and track
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-sm">
                    ...
                    <p className="text-gray-600 text-sm mb-4">
                      Connect your wallet to start saving immediately. You can
      ...
      <LinkWalletModal
        ...
        onClose={() => setIsLinkWalletModalOpen(false)}
        user={user}
